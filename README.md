...
<p align="center"><img src="./svgs/c35e3aa92f84213584bd304c19825906.svg" align=middle width=77.288145pt height=31.98558pt/></p>

where <img src="./svgs/07617f9d8fe48b4a7b3f523d6730eef0.svg" align=middle width=9.90495pt height=14.15535pt/> is the mean and <img src="./svgs/8cda31ed38c6d59d14ebefa440099572.svg" align=middle width=9.982995pt height=14.15535pt/> the standard deviation of the
...
shows the development of loss and accuracy over <img src="./svgs/08f4ed92f27cec32cdd7a6ecd580f9e7.svg" align=middle width=16.438455pt height=21.18732pt/> epochs of
...
regularization with <img src="./svgs/792f9d027e08cf5bcb47332a94c10a94.svg" align=middle width=68.94987pt height=22.83138pt/> and regularization with
<img src="./svgs/3241b9e887b30bfedec9223399a548c0.svg" align=middle width=60.73056pt height=22.83138pt/>. Only the loss is reported as the accuracy stays at
<img src="./svgs/e065f2ebe0e614eff29483ac1b642605.svg" align=middle width=38.356395pt height=24.6576pt/> and does not allow for nuanced analysis. With a low
<img src="./svgs/792f9d027e08cf5bcb47332a94c10a94.svg" align=middle width=68.94987pt height=22.83138pt/> both the train and test loss decrease. With a higher
weight decay of <img src="./svgs/3241b9e887b30bfedec9223399a548c0.svg" align=middle width=60.73056pt height=22.83138pt/>, the test loss\[1\] further decreases
...
weight decay with rate <img src="./svgs/1f3e30a75633bef3b9280e9be2e1ce1d.svg" align=middle width=37.44312pt height=21.18732pt/> and rate
<img src="./svgs/09b35b77d506cef3840e129c2e29ed1f.svg" align=middle width=29.223975pt height=21.18732pt/>.<span label="tab:regularization"></span>
...
such as <img src="./svgs/358d4d0949e47523757b4bc797ab597e.svg" align=middle width=21.004665pt height=21.18732pt/> shows that the simplicity of the problem allows for
choosing such high learning rates.

## Monk Dataset

The monk data set turned out to be a more complicated problem and the
model did not manage to achieve <img src="./svgs/e065f2ebe0e614eff29483ac1b642605.svg" align=middle width=38.356395pt height=24.6576pt/> accuracy. Figure
[4](#fig:perfmonk) shows the development of loss and accuracy. As a
learning rate, <img src="./svgs/1f3e30a75633bef3b9280e9be2e1ce1d.svg" align=middle width=37.44312pt height=21.18732pt/> showed to produce good results based on
...
after <img src="./svgs/88db9c6bd8c9a0b1527a1cedb8501c55.svg" align=middle width=24.657765pt height=21.18732pt/> epochs.
